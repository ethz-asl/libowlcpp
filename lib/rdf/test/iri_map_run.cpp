...
BOOST_AUTO_TEST_CASE( case04 ) {
   ...
   const Ns_id id2 = im.insert(iri2);
   const Ns_id id3 = im.insert(iri3);
   BOOST_CHECK( im.prefix(id1) == "" );
   BOOST_CHECK( im.prefix(id2) == "" );
   BOOST_CHECK( im.prefix(id3) == "" );
   im.insert_prefix(id1, "iri1");
   BOOST_CHECK( im.prefix(id1) == "iri1" );
   im.insert_prefix(id2, "iri2");
   BOOST_CHECK( im.prefix(id2) == "iri2" );
   im.insert_prefix(id3, "iri3");
   BOOST_CHECK( im.prefix(id3) == "iri3" );
}
