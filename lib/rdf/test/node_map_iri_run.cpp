/** @file "/owlcpp/lib/rdf/test/node_map_iri_run.cpp" 
part of owlcpp project.
@n @n Distributed under the Boost Software License, Version 1.0; see doc/license.txt.
@n Copyright Mikhail K Levin 2012
*******************************************************************************/
#define BOOST_TEST_MODULE node_map_iri_run
...
/** OWL-aware IRI node map
*******************************************************************************/
BOOST_AUTO_TEST_CASE( case02 ) {
   Node_map_iri nm( Node_map_std::get(Nodes_owl()) );
   BOOST_CHECK_EQUAL(nm.size(), 0U);

   Node const& node1 = nm.at(terms::T_owl_Class::id());
   BOOST_CHECK_EQUAL(node1.ns_id(), terms::N_owl::id());

   Node_map_iri::ns_range r1 = nm.find(terms::N_owl::id());
