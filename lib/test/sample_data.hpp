...
inline std::vector<Sample_info> const& sample_files() {
   ...
   /* 0 */("imports_test_01.owl", "http://owl-cpp.sf.net/test/owl/imports_test_01.owl", "")
   /* 1 */("negative_property_assertion_01.owl", "http://owl.semanticweb.org/page/New-Feature-NegativeObjectPropertyAssertion-001", "")
   /* 2 */("og_01.owl", "http://owl-cpp.sf.net/test/owl/og_01.owl", "")
   /* 3 */("og_02.owl", "http://owl-cpp.sf.net/test/owl/og_02.owl", "")
   /* 4 */("one_eq_two_01.owl", "http://owl-cpp.sf.net/test/owl/one_eq_two_01.owl", "")
   ...
   /* 8 */("owl2-rl-rules-ifp-sameAs.owl", "http://owl-cpp.sf.net/test/owl/owl2-rl-rules-ifp-sameAs.owl", "")
   /* 9 */("propertyChain_01.owl", "http://owl.semanticweb.org/page/New-Feature-ObjectPropertyChain-001", "")
   /* 10 */("test_01a.owl", "http://owl-cpp.sf.net/test/owl/test_01.owl", "http://owl-cpp.sf.net/test/owl/test_01a.owl")
   /* 11 */("transitive_property.owl", "http://owl-cpp.sf.net/test/owl/transitive_property.owl", "")
   /* 12 */("union_01.owl", "http://owl-cpp.sf.net/test/owl/union_01.owl", "")
